        ...
        fun isConnected():Boolean{
            ...
            if (Build.VERSION.SDK_INT >= 29){
                return manager.getNetworkCapabilities(manager.activeNetwork).let {
                    capabilities ->
                    return@let capabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET)&&capabilities.
                        hasCapability(NetworkCapabilities.NET_CAPABILITY_VALIDATED)  //第一个参数确保连上网络，第二个参数确保能访问网络
                }
